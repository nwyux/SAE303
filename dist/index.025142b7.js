...
})({"bTcdX":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ad4166d6025142b7";
"use strict";
...
},{}],"ejpMT":[function(require,module,exports) {
...
(async function ranking() {
    ...
    function construct(thirdElementData) {
        ...
        for(let i1 = 0; i1 < sorted.length; i1++){
            let index = tableausolved.indexOf(sorted[i1]);
        ...
        for(let i2 = 0; i2 < names.length; i2++){
            let solvednumber1 = timesolved(names[i2]);
            tableau2solved.push(solvednumber1);
        }
        let sorted2 = tableau2solved.slice().sort((b, a)=>a - b);
        let sortedNames2 = [];
        for(let i3 = 0; i3 < sorted2.length; i3++){
            let index1 = tableau2solved.indexOf(sorted[i3]);
            sortedNames2.push(names[index1]);
        }
        console.log("sorted", sorted2);
        let ranking = [];
        for(let i4 = 0; i4 < sorted.length; i4++){
            let index11 = sorted.indexOf(sorted[i4]);
            let index2 = sorted2.indexOf(sorted2[i4]);
            ranking.push(index11 + index2);
        }
        new (0, _auto.Chart)(document.getElementById("rankings"), {
            type: "bar",
            data: {
                labels: sortedNames,
                datasets: [
...
},{"chart.js/auto":"d8NN9"}]},["bTcdX","ejpMT"], "ejpMT", "parcelRequire30ab")

//# sourceMappingURL=index.025142b7.js.map
